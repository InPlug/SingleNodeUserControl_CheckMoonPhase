...
namespace Vishnu_UserModules
{
    ...
    /// TODO: Weiter unten können Sie Ihre eigenen ResultProperties zum Test
    /// befüllen (Kommentar beginnt ebenfalls mit TODO:).
    /// </summary>
    /// <remarks>
    ...
    public class SingleNodeViewModel : VishnuViewModelBase
    {
        ...
        public SingleNodeViewModel()
        {
            ...
            this._returnObject = new DateToMoonAge_ReturnObject()
            {
                // TODO: Hier können Sie Ihre eigenen ResultProperties zum Test befüllen.
                MoonAge = 12
            };
